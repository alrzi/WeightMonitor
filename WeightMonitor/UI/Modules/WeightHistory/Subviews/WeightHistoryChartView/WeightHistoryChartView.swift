                ...
                AxisMarks(position: .leading) { value in
                    ...
                    AxisValueLabel {
                        if let mass = value.as(Double.self) {
                            Text(Self.formatted(mass: mass, weightUnit: weightUnit))
                        }
                    }
                }
            }
...
private extension WeightHistoryChartView {
    static func formatted(mass: Double, weightUnit: WeightUnit) -> String {
        MassFormatter
            .twoDigits
            .string(
